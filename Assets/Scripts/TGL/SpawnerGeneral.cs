...
public class SpawnerGeneral : MonoBehaviour
{
    ...
    public  IEnumerator Start()
    {
        ...
        {
            AIControllerGoalsGeneral newInstance = Instantiate(prefab[Random.Range(0, prefab.Length)], spawns[Random.Range(0, spawns.Length)].position, Quaternion.Euler(0, Random.value * 360, 0),transform).GetComponent<AIControllerGoalsGeneral>();
